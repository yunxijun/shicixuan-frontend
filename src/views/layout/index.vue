...
.icon-gufengwujianzhongguofenggudaiqiwujiuqijue_huaban_huaban, .icon-gufengwujianzhongguofengshanzizheshan_huaban, .icon-bihualanhua{
  padding-left: 5px;
  margin-right: 8px;
  font-size: 24px;
}
