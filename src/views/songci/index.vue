<template>
  <div class='caocaoshiji'>
    ...
    <single-article class="onepoem" v-for='(item, index) in poems' :key='index' :articleTitle='item.rhythmic' :chapter="empty" :section="empty" :articleAuthor="item.author" :paragraphs="item.paragraphs">
    </single-article>
  </div>
</template>
